...
public class ManagementCart {
    ...
    public void insertFood(FullDomain item){
        FoodDomain foodDomain=new FoodDomain(item.getTitle(),item.getImg(),item.getDescription(),item.getFee(),item.getNumberInCart());
        insertFood(foodDomain);
